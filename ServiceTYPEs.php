...
// Select Data
$sql="SELECT * FROM ServiceTypes WHERE ServiceCAT = :ServiceCATEGORY";
...
foreach ($stmt as $row) {
   ...
   echo "<ul data-role='listview' data-inset='true'><li><a href='http://app.meathgoldcoast.com/ServicesSELECTED.php?id=".$row['Service']."'><img src='"."ServicePics/".$row['ServiceIcon']."'>".$row['Service']."</a></li></ul>\n";
	}
