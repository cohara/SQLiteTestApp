...
<!-- Header end -->
	...
	<div class="bannerbox" style="background-color:#3f8de0; height:109px">
         ...
         <h1 class="ui-title">Attractions</h1>
...
// Create connection
$con=mysqli_connect("localhost","m563520_Conor","MeathG0ldC0ast2015","m563520_MeathGoldCoast","3306");
...
// Select Data
$sql="SELECT AttractionID, Name, Logo1 FROM Attractions where Ranking<100 AND Display=1 order by Ranking";
...
<ul data-role="listview" data-inset="true">
	<li><a href="AttractionsDrogheda.php"> <img src="icons/Drogheda.png"/> Drogheda Tourist Attractions</a></li>
	<li><a href="AttractionsNearby.php"> <img src="AttractionImages/NearbyAttractions.jpg"/> Nearby Tourist Attractions</a></li>
