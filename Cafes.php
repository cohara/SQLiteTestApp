...
<!-- Header end -->
	...
	<div class="bannerbox" style="background-color:#3f8de0; height:109px">
         ...
         <h1 class="ui-title">Cafés & Coffee Shops</h1>
...
WHERE MGC_Services.ServiceID = ServiceClassifications.ServiceIDENTITY AND ServiceClassifications.ServiceType = 'Cafe' 
