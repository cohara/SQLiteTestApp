...
<!-- Header end -->
	...
	<div class="bannerbox" style="background-color:#3f8de0; height:109px">
         ...
         <h1 class="ui-title">Nearby Attractions</h1>
...
// Select Data
$sql="SELECT AttractionID, Name, Logo1 FROM Attractions where Ranking>100 AND Ranking<200 AND Display=1 order by Ranking";
